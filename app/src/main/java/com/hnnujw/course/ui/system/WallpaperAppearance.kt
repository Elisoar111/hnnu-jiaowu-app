...
fun rememberWallpaperRegionAppearance(
    ...
    darkTheme: Boolean = com.hnnujw.course.ui.theme.LocalAppAppearance.current.isDark
    ...
    val toneMap = com.hnnujw.course.ui.theme.rememberAppWallpaperToneMap(darkTheme)
