...
import com.hnnujw.course.ui.theme.LocalModuleEntrance
...
fun GrabProScreen(
    ...
    Scaffold(
        ...
        topBar = {
            ...
            SystemTopBar(title = "选课工作台", collapseFraction = headerCollapse)
            }
        },
        bottomBar = {
...
private fun ScheduleWarningDialog(
    ...
    SystemDialog(
        ...
        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            Text(
                text = "建议在选课前保持应用存活，并将应用加入电池优化白名单。",
...
private fun LogConsole(
    ...
    Column(Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
        ...
        Surface(
            modifier = Modifier.fillMaxWidth(),
            color = com.hnnujw.course.ui.system.glassSurfaceColor(),
            shape = RoundedCornerShape(16.dp),
            border = BorderStroke(0.5.dp, com.hnnujw.course.ui.system.glassBorderColor())
        ) {
            Box(
                modifier = Modifier
                    .fillMaxWidth()
