...
import com.hnnujw.course.academic.catalogGroupKey
import com.hnnujw.course.academic.catalogSelectionKey
import com.hnnujw.course.utils.CourseParser
import com.hnnujw.course.ui.system.GlassPullRefreshBox
...
import com.hnnujw.course.ui.theme.MotionSpecs
...
fun CourseListScreen(
    ...
    activeFilter: com.hnnujw.course.model.CourseFilter? = null,
    draftFilter: com.hnnujw.course.model.CourseFilter = com.hnnujw.course.model.CourseFilter(),
    onDraftFilterChange: (com.hnnujw.course.model.CourseFilter) -> Unit = {},
    onFilterApply: () -> Unit = {},
    onFilterClear: () -> Unit = {},
    ...
    val reduceMotion = com.hnnujw.course.ui.system.rememberGlassAccessibilityMode().reduceMotion
...
private fun BoxScope.FilterPanelOverlay(
    ...
    val reduced = com.hnnujw.course.ui.system.rememberGlassAccessibilityMode().reduceMotion
    ...
    AnimatedVisibility(
        ...
        enter = fadeIn(animationSpec = tween(if (reduced) 0 else com.hnnujw.course.ui.theme.MotionProfile.IconMillis)) +
            scaleIn(
                initialScale = if (reduced) 1f else 0.96f,
                transformOrigin = origin,
                animationSpec = com.hnnujw.course.ui.theme.MotionProfile.hierarchySpring()
            ),
                ...
                Row(
                    ...
                    Row(
                        ...
                        if (onSetFuzzyMatchTarget != null && !hasSelected) {
                            com.hnnujw.course.ui.system.SystemIconButton(
                        ...
                        IconButton(onClick = onExpandClick, enabled = isDetailsReady && !isLoading) {
                            com.hnnujw.course.ui.system.AnimatedLineIcon(
                                com.hnnujw.course.ui.system.AnimatedIconSpec.Expand, Modifier.size(20.dp),
                                state = when {
                                    isLoading -> com.hnnujw.course.ui.system.IconVisualState.Running
                                    isExpanded -> com.hnnujw.course.ui.system.IconVisualState.Expanded
    ...
    Column(
        ...
        Row(
            ...
            if (course.isSelected) {
                ...
                if (showTargetAction) com.hnnujw.course.ui.system.SystemIconButton(
...
private fun ActiveFilterBar(
    filter: com.hnnujw.course.model.CourseFilter,
    filterCategories: List<CourseParser.FilterCategory>,
    onClear: () -> Unit,
    isLoading: Boolean
) {
 ...
 */
internal fun com.hnnujw.course.model.CourseFilter.toDynamicDisplayTags(
    filterCategories: List<CourseParser.FilterCategory>
): List<String> {
