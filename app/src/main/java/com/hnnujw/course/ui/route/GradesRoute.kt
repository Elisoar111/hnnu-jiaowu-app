...
import com.hnnujw.course.manager.SessionRequestTicket
import com.hnnujw.course.manager.SessionRequestGate
...
import com.hnnujw.course.ui.screen.GradesScreen
...
fun GradesRoute() {
    ...
    com.hnnujw.course.ui.system.ReportPageContent(semesterGrades.isNotEmpty() || overallGrades.isNotEmpty() || examList.isNotEmpty())
    GradesScreen(
