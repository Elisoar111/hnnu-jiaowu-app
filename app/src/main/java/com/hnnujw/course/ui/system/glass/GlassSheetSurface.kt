...
fun Modifier.glassSheet(
    ...
    val surfaceColor = MaterialTheme.colorScheme.surface.copy(alpha = if (com.hnnujw.course.ui.system.rememberGlassDarkTheme())
        maxOf(material.surfaceAlpha, com.hnnujw.course.ui.system.LocalWallpaperAppearanceColors.current.surface.alpha) else material.surfaceAlpha)
