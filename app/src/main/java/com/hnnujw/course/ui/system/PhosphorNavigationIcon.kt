...
/** 第二课堂：奖章。绶带先画，圆牌压在上面，选中时绶带向两侧展开。 */
private fun DrawScope.drawMedal(t: Float, tint: Color, fill: Color) {
    val splay = 22f * flourish(t)
    drawLine(tint, Offset(104f, 142f), Offset(88f - splay, 224f), 16f, StrokeCap.Round)
    drawLine(tint, Offset(152f, 142f), Offset(168f + splay, 224f), 16f, StrokeCap.Round)
    drawCircle(fill, 56f, Offset(128f, 96f))
    drawCircle(tint, 56f, Offset(128f, 96f), style = outlineStroke)
    drawCircle(tint, 24f, Offset(128f, 96f), style = outlineStroke)
}
