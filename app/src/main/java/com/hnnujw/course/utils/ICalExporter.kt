...
object ICalExporter {
    ...
    fun generateICalContent(
        ...
        courses.forEach { course ->
            ...
            weekList.forEach { week ->
                ...
                sb.appendLine("UID:course-${com.hnnujw.course.schedule.ScheduleIdentity.digest(course.id)}-$eventDateStr@hnnu.edu.cn")
    ...
    private fun parseWeeks(weeksStr: String, totalWeeks: Int): List<Int> {
        return com.hnnujw.course.schedule.ScheduleWeeks.parse(weeksStr).weeks.filter { it <= totalWeeks }.sorted()
    }
