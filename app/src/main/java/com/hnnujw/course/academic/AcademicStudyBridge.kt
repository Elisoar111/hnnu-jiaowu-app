...
object AcademicStudyBridge {
    fun reader(school: SchoolConfig, account: String, expected: com.hnnujw.course.manager.SessionToken = UserManager.getInstance().sessionState.token): AcademicStudyAdapter {
