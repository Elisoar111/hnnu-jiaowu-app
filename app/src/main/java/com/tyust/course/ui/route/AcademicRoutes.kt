...
fun AcademicGrabQueueRoute(school: SchoolConfig) {
    ...
    fun start(scheduled: Boolean = false) {
        ...
        if (scheduled) {
            val trigger = com.tyust.course.utils.GrabTaskUtils.parseScheduledDateTime(scheduledDateTime)
    ...
    if (showDateTimePicker) GlassDateTimePickerDialog(title = "选择选课时间",
        ...
        scheduledDateTime = com.tyust.course.utils.GrabTaskUtils.formatScheduledDateTime(millis)
