...
fun MainScreen(
    ...
    LaunchedEffect(reminderRequest, currentAccountStorageKey) {
        if (reminderRequest != null) {
            ...
            if (com.tyust.course.schedule.ScheduleReminderScheduler.get(context).findById(reminderRequest) != null) selectedTab = 0
            else {
    ...
    LaunchedEffect(currentAccountStorageKey, foreground, isDemoMode) {
        ...
        com.tyust.course.academic.MessageCenterManager.refreshUnreadFromCache(context, currentAccountStorageKey)
                        ...
                        key(currentAccountStorageKey) {
                            ...
                            com.tyust.course.ui.theme.NavigationPages(navigationMotion,
                              ...
                              savedPages.SaveableStateProvider(items[page].route) {
                                when (page) {
                                    0 -> com.tyust.course.ui.route.ScheduleRoute()
                                    1 -> com.tyust.course.ui.route.GrabProRoute()
                                    2 -> com.tyust.course.ui.route.GradesRoute()
                                    3 -> com.tyust.course.ui.route.SecondClassroomRoute()
                                    4 -> com.tyust.course.ui.route.SettingsRoute()
                                    else -> com.tyust.course.ui.route.ScheduleRoute()
                                }
                              }
                            }
                        }
