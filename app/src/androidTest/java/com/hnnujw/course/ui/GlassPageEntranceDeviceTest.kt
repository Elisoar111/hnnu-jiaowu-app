...
class GlassPageEntranceDeviceTest {
    ...
    @Test fun selectedLabelsSurviveRepeatedPageChangesAndIdle() {
        ...
        com.hnnujw.course.ui.system.glass.GlassLensCaptureObserver.onCaptured = { tag, frame, bitmap ->
        ...
        } finally { com.hnnujw.course.ui.system.glass.GlassLensCaptureObserver.onCaptured = null }
    }
