...
class MainVisualDeviceTest {
    @Test fun captureLightDarkWallpaperNarrowLandscapeAndLargeText() {
        DemoUiDriver().use { ui ->
            ...
            try {
                ui.onMain { AppearanceSettingsManager.updateThemeMode(com.hnnujw.course.manager.AppThemeMode.System) }
                ...
                settle()
                capture("dark")
                ui.onMain { AppearanceSettingsManager.updateThemeMode(com.hnnujw.course.manager.AppThemeMode.Light) }
                settle()
